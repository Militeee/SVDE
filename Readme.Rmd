...
The package implements Bayesian Linear Regression for DE and library size normalization for single-cell RNA sequencing.

The package is based on PyTorch and the probabilistic programming language Pyro and provides seamingless integration with CUDA and SVI/HMC.
...
Salvatore Milite, MSc. _Huuman Technopole, Milano, Italy_.
